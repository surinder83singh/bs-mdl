...
<form>
  <fieldset class="form-group">
    <div class="form-element">
      <label for="exampleInputEmail1">Normal Label</label>
      <input type="text" class="form-control" id="exampleInputEmail1">
    </div>
    <small class="text-muted">We'll never share your email with anyone else.</small>
  </fieldset>
  <fieldset class="form-group label-float">
    <div class="form-element">
      <label for="exampleInputEmail2">Floating Label</label>
      <input type="text" class="form-control" id="exampleInputEmail2">
    </div>
    <small class="text-muted">We'll never share your email with anyone else.</small>
  </fieldset>
  <fieldset class="form-group always-label-float">
    <div class="form-element">
      <label for="exampleInputEmail2">Always Floating Label</label>
      <input type="text" class="form-control" id="exampleInputEmail2">
    </div>
    <small class="text-muted">We'll never share your email with anyone else.</small>
  </fieldset>
...
<label class="checkbox-inline has-success">
  <input type="checkbox" id="checkboxSuccess1" value="option1"> Checkbox with success
</label>
<label class="checkbox-inline has-warning">
  <input type="checkbox" id="checkboxWarning2" value="option1"> Checkbox with warning
</label>
<label class="checkbox-inline has-danger">
  <input type="checkbox" id="checkboxDanger3" value="option1"> Checkbox with danger
</label>
...
<label class="radio-inline has-success">
  <input type="radio" name="inlineRadioOptions" value="option4"> Radio with success
</label>
<label class="radio-inline has-warning">
  <input type="radio" name="inlineRadioOptions" value="option5"> Radio with warning
</label>
<label class="radio-inline has-danger">
  <input type="radio" name="inlineRadioOptions" value="option6"> Radio with danger
</label>
...
{% example html %}
<div class="form-group has-success label-float">
  <div class="form-element">
